...
from django.db.models import F, Sum, ExpressionWrapper, Avg
...
def on_time_delivery_rate(sender, instance, **kwargs):
    ...
    if instance.status == 'Completed' and instance.quality_rating is None:
        ...
        try:
            ...
            obj, created = Historical_Performance.objects.get_or_create(vendor = instance.vendor)
...
def quality_rating_avg(sender, instance, **kwargs):
    if instance.status == 'Completed' and instance.quality_rating is not None:
        ...
        try:
            ...
            historical_data, created = Historical_Performance.objects.get_or_create(vendor = instance.vendor)
...
def avg_response_time(sender, instance, **kwargs):
    if instance.status == 'Completed' and instance.acknowledgement_date is not None:
        # Calculate the difference between acknowledgement_date and issue_date
        date_diff_expression = ExpressionWrapper(F('acknowledgement_date') - F('issue_date'), output_field=fields.DurationField())
