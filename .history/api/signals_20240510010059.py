...
def update_historical_performance(sender, instance, **kwargs):
    ...
    if instance.on_time_delivery_rate is not None and instance.quality_rating_avg is not None
    and instance.avg_response_time is not None and instance.fulfillment_rate is not None:
