...
class VendorPerformanceSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.avg_response_time = validated_data.get('avg_response_time', instance.avg_response_time)
        instance.fulfillment_rate = validated_data.get('quality_rating_avg', instance.quality_rating_avg)
